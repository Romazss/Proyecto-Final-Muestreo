...
\begin{frame}{Herramientas en Python}
\begin{block}{Implementación en Python}
Herramientas complementarias para el análisis estadístico:
\end{block}
...
\begin{column}{0.45\textwidth}
\begin{itemize}
    \item[\textcolor{celesteprincipal}{$\checkmark$}] \texttt{pandas}
    \begin{itemize}
        \item Manipulación de datos
    \end{itemize}
    \item[\textcolor{celesteprincipal}{$\checkmark$}] \texttt{numpy}
    \begin{itemize}
        \item Cálculos numéricos
    \end{itemize}
\end{itemize}
\end{column}
...
\begin{column}{0.45\textwidth}
\begin{itemize}
    \item[\textcolor{celesteprincipal}{$\checkmark$}] \texttt{matplotlib} y \texttt{seaborn}
    \begin{itemize}
        \item Visualización avanzada
    \end{itemize}
    \item[\textcolor{celesteprincipal}{$\checkmark$}] \texttt{statsmodels}
    \begin{itemize}
