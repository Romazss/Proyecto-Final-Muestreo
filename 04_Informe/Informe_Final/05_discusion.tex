...
\begin{itemize}
    ...
    \item \textbf{Desarrollo territorial:} Integrar en políticas públicas el reconocimiento de la heterogeneidad regional, con énfasis en regiones de alta pobreza: La Araucanía ($\sim$10\%), Ñuble ($\sim$10\%) y Tarapacá ($\sim$9.4\%)
\end{itemize}
