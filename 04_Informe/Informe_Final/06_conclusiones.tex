...
\noindent
\textbf{Hallazgo 1:} La pobreza rural es 58\% mayor que la urbana (8.4\% vs 5.3\%, p $<$ 0.001), con heterogeneidad regional significativa. La Araucanía y Ñuble presentan las mayores tasas (9.97\%), mientras que Magallanes tiene la menor (2.73\%), una diferencia de 3.65 veces.

\vspace{0.4cm}

\noindent
\textbf{Hallazgo 2:} La educación media el 45\% del efecto de la zona sobre la pobreza. Cada año adicional de escolaridad reduce el odds de pobreza en 6\%.
...
\noindent
\textbf{Hallazgo 4:} La brecha salarial aumenta con el nivel educativo, alcanzando $\sim$25\% en personas con postgrado, evidenciando barreras estructurales más allá del capital humano.
...
\begin{description}
    ...
    \item[H2b:] \textbf{Confirmada.} La educación actúa como factor protector potente (OR = 0.94 por año), con rol mediador central en explicar la brecha territorial.
\end{description}
...
\begin{enumerate}
    \item Focalizar inversión educativa en regiones de alta pobreza: La Araucanía, Ñuble, Tarapacá, Atacama y Arica y Parinacota (tasas entre 7.4\% y 9.97\%)
    \item Implementar mecanismos de transparencia salarial para reducir discriminación, especialmente en ocupaciones de postgrado
