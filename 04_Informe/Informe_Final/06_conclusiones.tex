...
\noindent
\textbf{Hallazgo 1:} La pobreza rural es 58\% mayor que la urbana (8.4\% vs 5.3\%, p $<$ 0.001), con heterogeneidad regional significativa: Maule y Magallanes ($\sim$10\%) vs La Araucanía ($\sim$2.5\%).
...
\begin{enumerate}
    \item Focalizar inversión educativa en regiones de alta pobreza: Maule ($\sim$10\%), Arica y Parinacota ($\sim$9\%) y Magallanes ($\sim$10\%)
