...
\begin{table}[H]
    ...
    \midrule
    Tasa pobreza nacional & $\sim$6.5\% & Promedio ponderado nacional \\
    Regiones más pobres & La Araucanía, Ñuble, Tarapacá & $\sim$9--10\% (casi el doble) \\
    Regiones menos pobres & Magallanes, Aysén, Metropolitana & $\sim$2.7--3.7\% (menos de la mitad) \\
    \bottomrule
    \end{tabular}
...
Existe una marcada heterogeneidad territorial. Las regiones de La Araucanía y Ñuble presentan las mayores tasas de pobreza ($\sim$10\%), seguidas por Tarapacá (9.4\%) y Atacama (7.6\%). En contraste, las regiones extremas de Magallanes (2.7\%) y Aysén (3.4\%), junto con la Región Metropolitana (3.7\%), presentan los menores niveles de pobreza entre jefes de hogar. La Figura \ref{fig:pobreza_region} ilustra esta distribución.
