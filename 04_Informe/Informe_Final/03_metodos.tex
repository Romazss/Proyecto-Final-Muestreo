...
\begin{hallazgobox}
\textbf{Nota metodológica:} Este análisis utiliza un diseño simplificado (\texttt{ids = \textasciitilde1}) con pesos \texttt{expr}. Esto puede subestimar los errores estándar al ignorar la correlación intra-conglomerado. Para estimaciones de producción se recomienda usar el diseño complejo completo.
\end{hallazgobox}
